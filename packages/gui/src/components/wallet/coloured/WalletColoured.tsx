...
import { AlertDialog, Card, Flex } from '@renamemelite/core';
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_renamemelite = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_renamemelite = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_renamemelite = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_renamemelite +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +

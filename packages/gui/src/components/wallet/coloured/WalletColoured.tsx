...
import { AlertDialog, Card, Flex } from '@flaxlight/core';
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_flaxlight = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_flaxlight = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_flaxlight = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_flaxlight +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +

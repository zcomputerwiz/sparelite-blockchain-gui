...
import { Back, Flex, Loading, useShowError } from '@renamemelite/core';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@renamemelite/api-react';

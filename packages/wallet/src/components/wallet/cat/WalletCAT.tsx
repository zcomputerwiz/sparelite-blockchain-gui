...
import { Card, CopyToClipboard, Flex, Loading, useOpenDialog } from '@renamemelite/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@renamemelite/api-react';

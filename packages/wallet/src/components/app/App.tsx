...
import { Loading, ThemeProvider, ModalDialogsProvider, ModalDialogs } from '@flaxlight/core';
import { store, api } from '@flaxlight/api-react';
import { Wallet, ServiceName } from '@flaxlight/api';

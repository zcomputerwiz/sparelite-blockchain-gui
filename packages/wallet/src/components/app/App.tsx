...
import { Loading, ThemeProvider, ModalDialogsProvider, ModalDialogs } from '@sparelite/core';
import { store, api } from '@sparelite/api-react';
import { Wallet, ServiceName } from '@sparelite/api';

...
import { Loading, ThemeProvider, ModalDialogsProvider, ModalDialogs } from '@renamemelite/core';
import { store, api } from '@renamemelite/api-react';
import { Wallet, ServiceName } from '@renamemelite/api';
